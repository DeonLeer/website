...
export default function Navbar(props) {
  const tdStyle = props.notMode === 'Light' ? {backgroundColor: 'grey'} : {backgroundColor: 'white'};
  const buttonStyle = props.notMode === 'Light' ? {color: 'white', width: '100%'} : { width: '100%' };
  ...
  return (
    <div className="Navbar" id="Navbar">
      ...
      <div className="NavLinks">
        <table>
          <tr>
            <td style={tdStyle}><Button onClick={props.aboutMe} style={buttonStyle}>About me</Button></td>
